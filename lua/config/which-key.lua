...
local mappings = {
    ...
    g = {
        ...
        l = {"<cmd>Gvdiffsplit<cr><cmd>lua WinMove('l')<cr><cmd>NextHunk<cr>", "Vdiffsplit"},
        k = {"<cmd>PrevHunk<cr>", "Prev Hunk"},
        p = {"<cmd>PreviewHunk<cr>", "Preview Hunk"},
        r = {"<cmd>ResetHunk<cr><cmd>NextHunk<cr>", "Reset Hunk"},
        s = {"<cmd>StageHunk<cr><cmd>NextHunk<cr>", "Stage Hunk"},
